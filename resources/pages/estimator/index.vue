        ...
        <v-card class="profile">
          <v-row>
            <v-col sm="6" cols="12">
              ...
              <span class="profile__rate__text">4.6 Rating</span>
            </v-col>
          ...
          <v-row>
            <v-col sm="8" cols="12" class="jobs-completed">
              <b>
                <v-icon color="#3ce057" size="20px">mdi-check</v-icon> Jobs
                Completed</b
              >: 46
            </v-col>
              ...
              <v-simple-table class="table">
                <thead>
                  <tr>
                    ...
                    <th class="text-left">Data Assigned</th>
...
.profile .profile__rate__text {
  color: #7b7da3;
  font-size: 15px;
  font-weight: 600;
  background-color: #9ea4c436;
  display: inline-block;
  padding: 7px 5px;
  width: 120px;
  margin: 15px 10px;
